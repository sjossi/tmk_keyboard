...
[1] = { /* NumPad */
  ...
  {KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, FUNC(2), KC_SPC,  KC_SPC,  FUNC(1), KC_P0,    KC_TRNS, KC_TRNS, KC_TRNS}
},
[2] = { /* RAISE */
...
[3] = { /* LOWER */
  ...
  {KC_TRNS, FUNC(3), FUNC(4), KC_TRNS,  KC_INS, KC_TRNS, KC_TRNS, S(KC_MINS), S(KC_EQL),  S(KC_LBRC), S(KC_RBRC), S(KC_BSLS)},
